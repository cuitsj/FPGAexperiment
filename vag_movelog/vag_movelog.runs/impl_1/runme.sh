...
HD_PWD='F:/FPGAexperiment1/vag_movelog/vag_movelog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_movelog_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_movelog_top.tcl -notrace
