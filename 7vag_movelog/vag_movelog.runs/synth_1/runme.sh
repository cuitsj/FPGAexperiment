...
HD_PWD='F:/FPGAexperiment1/vag_movelog/vag_movelog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_movelog_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_movelog_top.tcl
