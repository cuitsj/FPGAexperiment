...
HD_PWD='F:/FPGAexperiment1/vga_colorbar/vga_colorbar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_colorbar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_colorbar.tcl
