...
HD_PWD='F:/FPGAexperiment1/vga_colorbar/vga_colorbar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_colorbar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_colorbar.tcl -notrace
