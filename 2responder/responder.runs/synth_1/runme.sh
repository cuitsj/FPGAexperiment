...
HD_PWD='F:/FPGAexperiment1/responder/responder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Responder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Responder.tcl
