...
HD_PWD='F:/FPGAexperiment1/responder/responder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Responder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Responder.tcl -notrace
